<?php namespace Dozensoftware\Listcraft\Commands;
...
class AttachCommand extends Command {
     ...
     * @var string
     */
    protected $name = 'listcraft:attach';
    ...
    {
        return array(
            array('table', InputArgument::REQUIRED, 'The name of the database table the Listcraft field will be added to.'),
            array('column', InputArgument::OPTIONAL, 'The name of the column to be used by Listcraft.', 'position')
        );
    }
    ...
    public function createMigration()
    {
        ...
        $migration = View::make('listcraft::migration', $data)->render();
